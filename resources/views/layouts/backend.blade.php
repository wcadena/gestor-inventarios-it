                    ...
                    <div class="content-header bg-white-10">
                        ...
                        <a class="font-w600 text-white tracking-wide" href="/">
                            <span class="smini-visible">
                                E<span class="opacity-75">i</span>
                            </span>
                            <span class="smini-hidden">
                                Ecua<span class="opacity-75">Inventarios</span>
                            </span>
                        </a>
                        <!-- END Logo -->
                            ...
                            <div class="dropdown-menu dropdown-menu-right p-0" aria-labelledby="page-header-user-dropdown">
                                ...
                                <div class="p-2">
                                    ...
                                    <a class="dropdown-item" href="javascript:void(0)">
                                        <i class="far fa-fw fa-file-alt mr-1"></i> Reportes
                                    </a>
                                    <div role="separator" class="dropdown-divider"></div>

                                    <!-- Toggle Side Overlay -->
                                    <!-- Layout API, functionality initialized in Template._uiApiLayout() -->
                                    <a class="dropdown-item" href="{{ url('/usuario/'.Auth::user()->id.'/edit') }}" data-toggle="layout" data-action="side_overlay_toggle">
                                        <i class="far fa-fw fa-building mr-1"></i> Configuración
                                    </a>
                                    <!-- END Side Overlay -->
                ...
                <div class="content py-0">
                    <div class="row font-size-sm">
                        <div class="col-sm-6 order-sm-2 mb-1 mb-sm-0 text-center text-sm-right">
                            Creado <i class="fa fa-heart text-danger"></i> por <a class="font-w600" href="#" target="_blank">Wágner Cadena</a>
                        </div>
                        <div class="col-sm-6 order-sm-1 text-center text-sm-left">
                            <a class="font-w600" href="#" target="_blank">Ecuatask</a> &copy; <span data-toggle="year-copy">2019</span>
                        </div>
                    </div>
                </div>
            </footer>
