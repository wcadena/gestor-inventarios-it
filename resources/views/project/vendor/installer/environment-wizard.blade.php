...
@section('container')
    ...
    @if ($message = \Session::get('my_error'))
        <div class="alert alert-primary" style="color: red;font-weight: bold">
            {!! $message !!}
        </div>
        @php(\Session::forget('my_error'))
    @endif
    ...
    <div class="tabs tabs-full">
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="" id="tab1content">
                ...
                <label for="tab1" class="tab-label" style="color: #333;">
...
{{--                </div>--}}
            ...
            <div class="" id="tab2content">


                <input id="tab2" type="radio" name="tabs" class="tab-input"/>
                <label for="tab2" class="tab-label" style="color: #333;">
...
{{--                </div>--}}
            ...
            <div class="" id="tab3content">
                <input id="tab3" type="radio" name="tabs" class="tab-input" checked />
                <label for="tab3" class="tab-label" style="color: #333;display: none;">
                ...
                <div class="margin-bottom-2" style="display: none;">
                    <!--
