        ...
        <div class="p-2">
            ...
            <div class="tab-content">
                <div class="tab-pane show active" id="home-b1">
                    <form method="post" id="form-comment" data-action="{{route('project.comment.store',[$currantWorkspace->slug,$task->project_id,$task->id,$clientID])}}">
                                    ...
                                    <div class="media-body">
                                        ...
                                        @if(empty($clientID))
                                            <div class="float-right">
                                                <a href="#" class="text-danger text-muted delete-comment" data-url="{{route('project.comment.destroy',[$currantWorkspace->slug,$task->project_id,$task->id,$comment->id])}}">
                ...
                <div class="tab-pane" id="profile-b1">
                    <form method="post" id="form-file" enctype="multipart/form-data" data-action="{{ route('project.comment.store.file',[$currantWorkspace->slug,$task->project_id,$task->id,$clientID]) }}">
                        @csrf
                                ...
                                <div class="card-body pt-2 pb-2">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            ...
                                            @if(empty($clientID))
                                                <a href="#" class="text-danger text-muted delete-comment-file" data-url="{{route('project.comment.destroy.file',[$currantWorkspace->slug,$task->project_id,$task->id,$file->id])}}">
                                                    <i class="dripicons-trash"></i>
                                                </a>
                                            @endif
                                        </div>
                ...
                @if(empty($clientID))
                    <div class="tab-pane show" id="sub-task">
                        ...
                        <form method="post" id="form-subtask" class="collapse" data-action="{{route('project.subtask.store',[$currantWorkspace->slug,$task->project_id,$task->id,$clientID])}}">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                ...
                                @foreach($task->sub_tasks as $subTask)
                                    <li class="list-group-item pt-2 pb-0">
                                        <label class="custom-switch pl-0">
                                            <input type="checkbox" name="option" value="{{$subTask->id}}" class="custom-switch-input" @if($subTask->status) checked @endif data-url="{{route('project.subtask.update',[$currantWorkspace->slug,$task->project_id,$subTask->id])}}">
                                        ...
                                        <div class="float-right">
                                            <a href="#" class="text-danger text-muted delete-subtask" data-url="{{route('project.subtask.destroy',[$currantWorkspace->slug,$task->project_id,$subTask->id])}}">
                                                <i class="dripicons-trash"></i>
                                            </a>
                                        </div>
                                    </li>
