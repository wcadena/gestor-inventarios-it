   ...
   <v-layout row justify-center  >
    <v-dialog v-model="dialog" persistent max-width="290">
     ...
     <v-card>
      ...
      <v-card-actions>
       <v-spacer></v-spacer>
       <v-btn color="green darken-1" flat @click="form.terms = false; dialog = false">De Acuerdo</v-btn>
       <v-btn color="green darken-1" flat @click="form.terms = true; dialog = false">Agree</v-btn>
      </v-card-actions>
     </v-card>
    </v-dialog>
   </v-layout>
