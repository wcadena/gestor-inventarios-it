...
$factory->define(App\Models\InformeMantenimientoPreventivo::class, function (Faker $faker) {
    return [
        ...
        'informe_manto_prev_cate_id'         => function () {
            return App\Models\InformeMantenimientoPreventivoCategoria::inRandomOrder()->first()->id;
        },
