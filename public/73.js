...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b0928f74", Component.options)
  } else {
    hotAPI.reload("data-v-b0928f74", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      brand: __WEBPACK_IMPORTED_MODULE_1_Constants_AppConfig__["a" /* default */].brand
    };
  },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-b0928f74", module.exports)
  }
}
