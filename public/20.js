...
/* script */
var __vue_script__ = __webpack_require__(2126)
/* template */
...
Component.options.__file = "resources/js/views/drag-drop/VueDraggableResizable.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7caf70e4", Component.options)
  } else {
    hotAPI.reload("data-v-7caf70e4", Component.options)
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_draggable_resizable__ = __webpack_require__(2127);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    VueDraggableResizable: __WEBPACK_IMPORTED_MODULE_0_vue_draggable_resizable___default.a
  }
});
  ...
  return _c(
    ...
    [
      ...
      _c(
        ...
        [
          _c("app-card", { attrs: { heading: "Draggable Resizable" } }, [
            _c(
              "div",
              {
                staticStyle: {
              ...
              [
                _c(
                  ...
                  {
                    attrs: { w: 300, h: 170, parent: true },
                    on: { dragging: _vm.onDrag, resizing: _vm.onResize }
                  },
                  [
                    _c(
                      "v-card",
                      { attrs: { hover: "", height: "100%" } },
                      [
                        _c("v-card-text", [
                          _c("p", [
                            _vm._v(
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7caf70e4", module.exports)
  }
}
