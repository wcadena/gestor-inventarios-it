...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1fb376c0", Component.options)
  } else {
    hotAPI.reload("data-v-1fb376c0", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      fcEvents: __WEBPACK_IMPORTED_MODULE_1__events__["a" /* default */]
    };
  },
...
/* harmony default export */ __webpack_exports__["a"] = ([{
  title: 'Event 1',
  allDay: true,
  start: __WEBPACK_IMPORTED_MODULE_0_moment___default()(),
  end: __WEBPACK_IMPORTED_MODULE_0_moment___default()().add(1, 'd')
}, {
  title: 'Event 2',
  start: __WEBPACK_IMPORTED_MODULE_0_moment___default()().add(2, 'd'),
  end: __WEBPACK_IMPORTED_MODULE_0_moment___default()().add(2, 'd').add(2, 'h')
}]);
        ...
        [
          _c("div", { staticClass: "app-card" }, [
            _c(
              ...
              [
                _c("full-calendar", {
                  attrs: { events: _vm.fcEvents, lang: "en" }
                })
              ],
              1
            )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-1fb376c0", module.exports)
  }
}
